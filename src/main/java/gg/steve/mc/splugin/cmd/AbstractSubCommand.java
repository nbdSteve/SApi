package gg.steve.mc.splugin.cmd;

import gg.steve.mc.splugin.cmd.exception.AliasAlreadyRegisteredException;
import gg.steve.mc.splugin.permission.Permission;
import lombok.Data;
